...
{
    public enum States {Begin, E, H, F, M, S, G, L, K }
    ...
    internal class Program
    {
        ...
        static void Main()
        {
            ...
            {
                new State(States.E, "!", States.H),
                new State(States.E, "!", States.F),

                new State(States.H, "c", States.L),
                new State(States.H, "b", States.G),

                new State(States.L, "c", States.H),
                new State(States.L, "b", States.M),

                new State(States.M, "b", States.H),
                new State(States.M, "a", States.K),
                new State(States.M, "1", States.M),
                new State(States.M, "0", States.M),
                new State(States.M, "!", States.S),

                new State(States.S, "!", States.G),

                new State(States.G, "a", States.F),
                new State(States.G, "0", States.G),
                new State(States.G, "1", States.G),
                new State(States.K, "-", States.E)
            };
